...
class NewsController extends Controller
{
  ...
  {
    $posts = News::find()->select('id, post_type')->orderBy(['date_created' => SORT_DESC])->all();
  ...
  public function actionView( $id )
  {
      ...
      $LikeCount = count(Rep::find()->where(['type' => 'news', 'article_id' => $id, 'reputation' => 'like'])->all());
      $DislikeCount = count(Rep::find()->where(['type' => 'news', 'article_id' => $id, 'reputation' => 'dislike'])->all());
      $isLike = false;
      $isDislike = false;
      if ($_SESSION['user'])
      {
         $userRep = Rep::find()->where(['type' => 'news', 'article_id' => $id, 'user_id' => $_SESSION['user']['id']])->all();
         if ($userRep)
         {
	...
	public function actionAdd()
  {
    ...
    public function actionComment()
    {
        if(\Yii::$app->request->post())
        {
            ...
            return $this->redirect(['news/view', 'id' => $data['article_id']]);
        }
