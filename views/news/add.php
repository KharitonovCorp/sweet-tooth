...
$this->params['page_title'] = 'Новая новости';
$this->params['page_description'] = 'Самые свежие новости из мира кулинарии';

$this->params['page_main_btn_link'] = Url::toRoute([$page_type.'/add']);
$this->params['page_main_btn_text'] = 'Добавить новость';
